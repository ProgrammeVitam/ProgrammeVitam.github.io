...
* [8.0.3 - juillet 2026](#803)
* [8.0.2 - janvier 2026](#802)
...
<a name="803"></a>
### Version 8.0.3 (juillet 2026)

#### Les packages java (.jar) associés, diffusés pour Maven

Ils sont accessibles en suivant utilisant ce [lien](https://download.programmevitam.fr/vitam_repository/8.0.3/mvn_repo/).
...
Ils permettent d’installer de manière outillée la solution. Ils contiennent aussi des conteneurs de documentation et de jeux de tests. 
    - Pour [Vitam](https://github.com/ProgrammeVitam/deployment/tree/8.0.3/vitam)  
    - Pour [Vitam UI](https://github.com/ProgrammeVitam/deployment/tree/8.0.3/vitam-ui)

##### *Vitam back-office*

- Publication [GitHub Vitam](https://github.com/ProgrammeVitam/vitam/tree/8.0.3)
- URL de configuration du [repository Maven](https://download.programmevitam.fr/vitam_repository/8.0.3/mvn_repo/) 
- URL de configuration des dépôts de binaires CentOS/RHEL :  
    - [vitam-product](https://download.programmevitam.fr/vitam_repository/8.0.3/rpm/vitam-product/)  
    - [vitam-external](* https://download.programmevitam.fr/vitam_repository/8.0.3/rpm/vitam-external/)  
- URL de configuration des dépôts de binaires Debian :  
    - [vitam-product](https://download.programmevitam.fr/vitam_repository/8.0.3/deb/vitam-product/)  
    - [vitam-external](https://download.programmevitam.fr/vitam_repository/8.0.3/deb/vitam-external/)

##### *Vitam UI*

- Publication [GitHub Vitam UI](https://github.com/ProgrammeVitam/vitam-ui/tree/8.0.3)
- URL de configuration du [repository Maven](https://download.programmevitam.fr/vitamui_repository/8.0.3/mvn_repo/)
- URL de configuration des [dépôts de binaires CentOS/RHEL](https://download.programmevitam.fr/vitamui_repository/8.0.3/rpm/)
- URL de configuration des [dépôts de binaires Debian](https://download.programmevitam.fr/vitamui_repository/8.0.3/deb/)

Liens de téléchargement pour les partenaires :  [**version 8.0.3**](https://releases.programmevitam.fr/8.0.3/index.html)
 
##### La release note

- la [release note de la version 8.0](/ressources/RefCourant/Release_notes_v8.0_v1.0.pdf)
- le [change-log du back-office 8.0.2](/ressources/RefCourant/vitam-changelog.8.0.3.pdf)
- le [change-log du front-office 8.0.2](/ressources/RefCourant/vitamui-changelog.8.0.3.pdf)

<a name="802"></a>
### Version 8.0.2 (janvier 2026)

#### Les packages java (.jar) associés, diffusés pour Maven

Ils sont accessibles en suivant utilisant ce [lien](https://download.programmevitam.fr/vitam_repository/8.0.2/mvn_repo/).
...
Ils permettent d’installer de manière outillée la solution, sous forme RPM pour CentOS 7 et AlmaLinux 9 et sous forme DEB pour Debian 11 et 12. Ils contiennent aussi des conteneurs de documentation et de jeux de tests. 
    - Pour [Vitam](https://github.com/ProgrammeVitam/deployment/tree/8.0.2/vitam)  
    - Pour [Vitam UI](https://github.com/ProgrammeVitam/deployment/tree/8.0.2/vitam-ui)

##### *Vitam back-office*

- Publication [GitHub Vitam](https://github.com/ProgrammeVitam/vitam/tree/8.0.2)
- URL de configuration du [repository Maven](https://download.programmevitam.fr/vitam_repository/8.0.2/mvn_repo/) 
- URL de configuration des dépôts de binaires CentOS/RHEL :  
    - [vitam-product](https://download.programmevitam.fr/vitam_repository/8.0.2/rpm/vitam-product/)  
    - [vitam-external](* https://download.programmevitam.fr/vitam_repository/8.0.2/rpm/vitam-external/)  
- URL de configuration des dépôts de binaires Debian :  
    - [vitam-product](https://download.programmevitam.fr/vitam_repository/8.0.2/deb/vitam-product/)  
    - [vitam-external](https://download.programmevitam.fr/vitam_repository/8.0.2/deb/vitam-external/)

##### *Vitam UI*

- Publication [GitHub Vitam UI](https://github.com/ProgrammeVitam/vitam-ui/tree/8.0.2)
- URL de configuration du [repository Maven](https://download.programmevitam.fr/vitamui_repository/8.0.2/mvn_repo/)
- URL de configuration des [dépôts de binaires CentOS/RHEL](https://download.programmevitam.fr/vitamui_repository/8.0.2/rpm/)
- URL de configuration des [dépôts de binaires Debian](https://download.programmevitam.fr/vitamui_repository/8.0.2/deb/)

Liens de téléchargement pour les partenaires :  [**version 8.0.2**](https://releases.programmevitam.fr/8.0.2/index.html)
...
Liens de téléchargement pour les partenaires :  [**version 8.0.1**](https://releases.programmevitam.fr/8.0.1/index.html)
 
##### La release note

- la [release note de la version 8.0.0](/ressources/RefCourant/Release_notes_v8.0_v1.0.pdf)
- le [change-log du back-office 8.0.1](/ressources/RefCourant/vitam-changelog.8.0.1.pdf)
- le [change-log du front-office 8.0.1](/ressources/RefCourant/vitamui-changelog.8.0.1.pdf)
