...
- Publication [GitHub Vitam](https://github.com/ProgrammeVitam/vitam/tree/7.1.5)
...
- Publication [GitHub Vitam UI](https://github.com/ProgrammeVitam/vitam-ui/tree/7.1.5)
- URL de configuration du [repository Maven](https://download.programmevitam.fr/vitamui_repository/7.1.5/mvn_repo/)
- URL de configuration des [dépôts de binaires CentOS/RHEL](https://download.programmevitam.fr/vitamui_repository/7.1.5/rpm/)
- URL de configuration des [dépôts de binaires Debian](https://download.programmevitam.fr/vitamui_repository/7.1.5/deb/)

Liens de téléchargement pour les partenaires :  [**version 7.1.5**](https://support.programmevitam.fr/releases/7.1.5/index.html)
