...
* **Guide de lecture de la documentation** - guide d’orientation dans la documentation : quels documents pouvez-vous lire selon votre rôle et vos attentes ?... avec une description de chaque document ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Guide_de_lecture_de_la_documentation.pdf))
...
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Guide_de_prise_en_main.pdf)) avec les fichiers d'exemple utiles ([zip](http://download.programmevitam.fr/vitam_repository/1.10.0/tests/Jeu_de_tests_Guide_de_prise_en_main_R8.zip))
...
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Presentation_solution_logicielle.pdf))


## Documentation métier

* **Manuel utilisateur** ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-manuel-utilisateur.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0-1/html/manuel-utilisateur))
...
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Organisation_de_l_information.pdf))
* **Spécification des SIP** - recommandations sur la construction des paquets 
à archiver ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Structuration_des_SIP.pdf))
...
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Structuration_des_DIP.pdf))
* **Profils d’archivage** - éléments sur la notion de profil d’archivage (SEDA) ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Profils_d_archivage.pdf))
* **Profils d’unité archivistique** - éléments sur la notion de profil d’unité archivistique ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Profils_unite_archivistique.pdf))
* **Gestion des habilitations** - présentation des fonctionnalités associées à la gestion et à
l’utilisation des habilitations (gestion des utilisateurs applicatifs et de leurs droits) ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Gestion_des_habilitations.pdf))
* **Services producteurs** - présentation des fonctionnalités associées à la
notion de service producteur ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Services_producteurs.pdf))
...
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Arbre_de_positionnement_et_plan_de_classement.pdf))
* **Règles de gestion** - présentation du principe des règles de gestion et de leur héritage 
([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Regles_de_gestion.pdf))
* **Modèle de workflow**  - description de la décompositon et du séquencement des
 opérations ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-modele-workflow.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/workflow-model))
* **Conservation de la valeur probante** - présentation de la sécurisation des journaux ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Valeur_probante.pdf))


## Documentation des tests

* **Manuel IHM recette** ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-ihm-recette.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0-1/html/ihm-recette))
* **Scenarii de tests métier** - description de la stratégie des tests ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-scenario-tests.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0-1/html/scenario-test))
* **Cahier de tests métier** - liste des tests manuels sur les IHM ([pdf](/ressources/Doc1.10.0-1/autres/fonctionnel/VITAM_Cahier_de_tests_metiers.pdf)) avec les fichiers de tests associés ([zip](http://download.programmevitam.fr/vitam_repository/1.10.0/tests/Jeux_de_tests_fonctionnels_RELEASE8_SEDA2.1.zip))


## Documentation technique

* **Dossier d'architecture technique** (DAT) ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-architecture.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/archi))
* **Dossier d'exploitation** (DEX) ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-documentation-exploitation.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/exploitation))
* **Dossier d'installation** (DIN) ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-documentation-installation.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/installation))
* **Documentation de montées de version (DMV) ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-documentation-migration.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/migration))

## Documentation développeur

* **Javadoc** ([html](/ressources/Doc1.10.0-1/javadoc))
* **Manuel d'intégration applicative** - présentation des principes de d'usage des interfaces ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-manuel-developpement.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/manuel-integration))
* **Modèle de données** - description des collections et des champs standards  
([pdf](/ressources/Doc1.10.0-1/pdf/vitam-datamodel.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0-1/html/data-model))
* **Documentation d'API externes** - description des API REST externes en Html ([html](/ressources/Doc1.10.0-1/raml/externe/index.htm))
* **Manuel de développement** - éléments d'architecture interne et de méthode utiles aux développements de la solution logicielle VITAM ([pdf](/ressources/Doc1.10.0-1/pdf/vitam-manuel-developpement.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0-1/html/manuel-dev))
* **Documentation d'API internes** - description des API REST internes en Html et Raml ([html&raml](/ressources/Doc1.10.0-1/raml/interne/index.htm))
