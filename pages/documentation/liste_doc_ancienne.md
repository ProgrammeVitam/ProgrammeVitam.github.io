...
## Première approche
* **Guide de lecture de la documentation** - guide d’orientation dans la documentation : quels documents pouvez-vous lire selon votre rôle et vos attentes ?... avec une description de chaque document ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Guide_de_lecture_de_la_documentation.pdf))
...
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Guide_de_prise_en_main.pdf)) avec les fichiers d'exemple utiles ([zip](https://download.programmevitam.fr/jeux_de_tests/v5rc/Jeux_de_tests_Guide_de_prise_en_main_V5_RC.zip))
* **Présentation de la solution logicielle** - mode de développement, vision générale fonctionnelle et technique de la solution
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Presentation_solution_logicielle.pdf))

**[Télécharger toute la documentation métier et Vitam UI](/ressources/Doc5.RC/autres/fonctionnel/Vitam_doc_totalite.zip)**

**[Télécharger toute la documentation métier](/ressources/Doc5.RC/autres/fonctionnel/Vitam_doc_metier.zip)**

## Documentation métier
* **Manuel utilisateur** ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Manuel_utilisateur_IHM.pdf))
...
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Organisation_de_information.pdf))
* **Spécification des SIP** - recommandations sur la construction des paquets
à archiver ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Structuration_des_SIP.pdf))
...
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Structuration_des_DIP.pdf))
* **Gestion des archives et des arborescences** (ancienne documentation "Arbre de positionement et plan de classement"
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Gestion_archives_arborescences.pdf))
* **Règles de gestion** - présentation du principe des règles de gestion et de leur héritage
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Regles_de_gestion.pdf))
* **Services producteurs** - présentation des fonctionnalités associées à la
notion de service producteur ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Services_producteurs.pdf))
* **Eliminations** - présentation des fonctionnalités de mise en oeuvre des éliminations d'archives avec la solution logicielle Vitam ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Eliminations.pdf))
* **Préservation** - présentation des fonctionnalités de mise en oeuvre de la préservation à long-terme des archives avec la solution logicielle Vitam ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Preservation.pdf))
* **Profils d’archivage** - éléments sur la notion de profil d’archivage (SEDA) ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Profils_archivage.pdf))
* **Profils d’unité archivistique** - éléments sur la notion de profil d’unité archivistique ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Profils_unite_archivistique.pdf))
* **Ontologie** - éléments sur la notion d'ontologie ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Ontologie.pdf))
* **Conservation de la valeur probante** - présentation de la sécurisation des journaux ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Conservation_valeur_probante.pdf))
...
* **Manuel IHM recette et Scenarii de tests métier** ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_IHM_Recette.pdf))
...
* **Vitam back-office : dossier d'architecture technique** (DAT) ([pdf](/ressources/Doc5.RC/pdf/vitam-architecture.5.rc.1.pdf) \| [html](/ressources/Doc5.RC/html/archi))  

* **Vitam back-office : dossier d'installation** (DIN) ([pdf](/ressources/Doc5.RC/pdf/vitam-documentation-installation.5.rc.1.pdf) \| [html](/ressources/Doc5.RC/html/installation))

* **Vitam back-office : dossier d'exploitation** (DEX) ([pdf](/ressources/Doc5.RC/pdf/vitam-documentation-exploitation.5.rc.1.pdf) \| [html](/ressources/DocCourante/html/exploitation))  

* **Vitam UI : dossier d'installation** ([html](/ressources/Doc5.RC/html/install_ui_v5rc_html))  

* **Vitam UI : dossier d'exploitation** ([html](/ressources/Doc5.RC/html/exploitation_ui_v5rc_html))  

* **Documentation de montées de version** (DMV) ([pdf](/ressources/Doc5.RC/pdf/vitam-documentation-migration.5.rc.1.pdf) \| [html](/ressources/Doc5.RC/html/migration))  

## Documentation développeur

* **Javadoc** ([html](/ressources/Doc5.RC/javadoc))
* **Manuel d'intégration applicative** - présentation des principes de d'usage des interfaces ([pdf](/ressources/Doc5.RC/pdf/vitam-manuel-integration.4.0.3.pdf) \| [html](/ressources/Doc5.RC/html/manuel-integration))
* **Modèle de données** - description des collections et des champs standards  
([pdf](/ressources/Doc5.RC/autres/fonctionnel/VITAM_Modele_de_donnees.pdf))
* **Documentation d'API externes** - description des API REST externes en Html ([html](/ressources/Doc5.RC/raml/externe))
* **Manuel de développement** - éléments d'architecture interne et de méthode utiles aux développements de la solution logicielle VITAM ([pdf](/ressources/Doc5.RC/pdf/vitam-manuel-developpement.4.0.3.pdf)
\| [html](/ressources/Doc5.RC/html/manuel-dev))
* **Documentation d'API internes** - description des API REST internes en Html et Raml ([html&raml](/ressources/Doc5.RC/raml/interne))
...
* **Vitam UI : documentation produit** ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VitamUI_Doc_produit.pdf))
* **Vitam UI : guide de prise en main** ([pdf](/ressources/Doc5.RC/autres/fonctionnel/VitamUI_Guide_de_prise_en_main.pdf))
...
<caption><b>Domaine : organisation et droits utilisateurs<a name="orga"></a></b></caption>
	...
	<tr>
		...
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_organisation.pdf">Organisation</a></td>
	</tr>
	<tr>
		...
		<td>administrateur d'instance (si vous exposez Vitam UI en tant que service), administrateur technique VitamUI (si vous utilisez Vitam UI hébergé en propre)</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_subrogation.pdf">Subrogation</a></td>
	</tr>
	<tr>
		...
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_profil_app_utilisateur.pdf">Profil APP Utilisateur</a></td>
	</tr>
	<tr>
		...
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_groupe_profil.pdf">Groupes de profils</a></td>
	</tr>
	<tr>
		<td>1.4 (obligatoire sauf si le groupe existe déjà)</td>
		<td>... créer mes utilisateurs et leur attribuer des droits</td>
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_utilisateur.pdf">Utilisateur</a></td>
	</tr>
		<tr>
		<td>1.5 (facultatif)</td>
		<td>... paramétrer des profils de droits permettant d’associer un contrat d’accès à un utilisateur</td>
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Profil_APP_Parametrages_externes.pdf">Profil APP Paramétrages externes</a></td>
	</tr>
</table>
...
<caption><b>Domaine : référentiels<a name="referentiels"></a></b></caption>
	...
	<tr>
		...
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_services_agents.pdf">Services agents</a></td>
	</tr>
	<tr>
		<td>2.2 (Règles de gestion)</td>
		<td>... déclarer des nouvelles règles de gestion</td>
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Regles_gestion.pdf">Règles de gestion</a></td>
	</tr>
	<tr>
		...
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_formats_fichiers.pdf">Formats de fichier</a></td>
	</tr>
	<tr>
		<td>2.3 (facultatif)</td>
		<td>... déclarer un nouveau vocabulaire non présent dans l'ontologie SEDA</td>
		<td>administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_ontologie.pdf">Ontologie</a></td>
	<tr>
		<td>2.4 (facultatif)</td>
		<td>... importer un arbre de positionnement ou un plan de classement</td>
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Arbres_plans.pdf">Arbres et plans</a></td>
	</tr>
	</tr>
</table>
...
<caption><b>Domaine : sécurité et droits applicatifs<a name="secu"></a></b></caption>
	...
	<tr>
		...
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Contrat_entree.pdf">Contrat d'entrée</a></td>
	</tr>
	<tr>
		...
		<td>administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Contrat_acces.pdf">Contrat d'accès</a></td>
	</tr>
	<tr>
		...
		<td>administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Profil_securite.pdf">Profil de sécurité</a></td>
	</tr>
	<tr>
		...
		<td>administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Contexte_applicatif.pdf">Contexte applicatif</a></td>
	</tr>
</table>
...
<caption><b>Domaine : supervision et audit<a name="supervision"></a></b></caption>
	...
	<tr>
		...
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Journal_operations.pdf">Journal des opérations</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... visualiser les opérations de sécurisation et accéder aux journaux du cycle de vie des objets</td>
		<td>administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_operations_securisation.pdf">Opérations de sécurisation</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... effectuer des requêtes complexes sur les bases de données documentaires en vue de retrouver des objets</td>
		<td>administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_RequetesDSL.pdf">Requêtes DSL</a></td>
	</tr>
	<tr>
		<td>NA</td>
		...
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Audit.pdf">Audit</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... produire un relevé de valeur probante sur une ou plusieurs de mes archives électroniques</td>
		<td>administrateur fonctionnel Vitam UI, super-archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_releve_valeur_probante.pdf">Relevé de valeur probante</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... gérer des opérations et interagir sur les étapes du workflow des opérations</td>
		<td>administrateur fonctionnel Vitam UI, super-archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Gestion_operations.pdf">Gestion des opérations</a></td>
</table>
...
<caption><b>Domaine : versement et consultation<a name="versement"></a></b></caption>
	...
	<tr>
		...
		<td>archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Depot_suivi_versements.pdf">Dépôt et suivi des versements</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... rechercher et télécharger des unités archivistiques contenues dans le SAE</td>
		<td>archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Recherche_et_consultation.pdf">Recherche et consultation des archives</a></td>
	</tr>
	<tr>
	</tr>
	<tr>
		...
		<td> archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc5.RC/autres/fonctionnel/VitamUI_DocAPP_Registre_des_fonds.pdf">Registre des fonds</a></td>
</table>
...
## Première approche
* **Guide de lecture de la documentation** - guide d’orientation dans la documentation : quels documents pouvez-vous lire selon votre rôle et vos attentes ?... avec une description de chaque document ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Guide_de_lecture_de_la_documentation.pdf))
* **Guide de prise en main** - guide vous permettant d'effectuer les premiers paramétrages et une première entrée d'archives dans la solution logicielle Vitam
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Guide_de_prise_en_main.pdf)) avec les fichiers d'exemple utiles ([zip](https://download.programmevitam.fr/jeux_de_tests/r16/Jeux_de_tests_Guide_de_prise_en_main_R16.zip))
* **Présentation de la solution logicielle** - mode de développement, vision générale fonctionnelle et technique de la solution
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Presentation_solution_logicielle.pdf))

**[Télécharger toute la documentation métier et Vitam UI](/ressources/Doc4.0.0/autres/fonctionnel/Vitam_doc_totalite.zip)**

**[Télécharger toute la documentation métier](/ressources/Doc4.0.0/autres/fonctionnel/Vitam_doc_metier.zip)**

## Documentation métier
* **Manuel utilisateur** ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Manuel_utilisateur_IHM.pdf))
* **Organisation de l'information** - présentation des exigences fonctionnelles et des objets métiers utilisés par la solution logicielle Vitam
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Organisation_de_information.pdf))
* **Spécification des SIP** - recommandations sur la construction des paquets
à archiver ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Structuration_des_SIP.pdf))
* **Structuration des DIP** - éléments sur la construction paquets d'archives transmis par le système d’archivage pour consultation
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Structuration_des_DIP.pdf))
* **Gestion des archives et des arborescences** (ancienne documentation "Arbre de positionement et plan de classement"
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Gestion_archives_arborescences.pdf))
* **Règles de gestion** - présentation du principe des règles de gestion et de leur héritage
([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Regles_de_gestion.pdf))
* **Services producteurs** - présentation des fonctionnalités associées à la
notion de service producteur ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Services_producteurs.pdf))
* **Eliminations** - présentation des fonctionnalités de mise en oeuvre des éliminations d'archives avec la solution logicielle Vitam ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Eliminations.pdf))
* **Préservation** - présentation des fonctionnalités de mise en oeuvre de la préservation à long-terme des archives avec la solution logicielle Vitam ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Preservation.pdf))
* **Profils d’archivage** - éléments sur la notion de profil d’archivage (SEDA) ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Profils_archivage.pdf))
* **Profils d’unité archivistique** - éléments sur la notion de profil d’unité archivistique ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Profils_unite_archivistique.pdf))
* **Ontologie** - éléments sur la notion d'ontologie ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Ontologie.pdf))
* **Conservation de la valeur probante** - présentation de la sécurisation des journaux ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Conservation_valeur_probante.pdf))
* **Gestion des habilitations** - présentation des fonctionnalités associées à la gestion et à
l’utilisation des habilitations (gestion des utilisateurs applicatifs et de leurs droits) ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Gestion_habilitations.pdf))
* **Modèle de workflow**  - description de la décompositon et du séquencement des
 opérations ([pdf - partie 1](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Modele_de_workflow_part1.pdf)) ([pdf - partie 2](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Modele_de_workflow_part2.pdf))
* **Gestion de multiples stratégies de stockage** - présentation des fonctionnalités associées à la gestion et à la réalisation d'opérations de préservation numérique ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Multi_strategies.pdf))
* **Le transfert avec la solution logicielle Vitam** ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Transfert.pdf))
* **Manuel ReSIP** - Fonctionnalités et utilisation de l'outil ReSIP ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_Manuel_ReSIP.pdf))

## Documentation des tests
* **Manuel IHM recette et Scenarii de tests métier** ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_IHM_Recette.pdf))
* **Cahier de tests métier** - liste des tests manuels sur les IHM aux formats Calc ([ods](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_cahier_de_recette_fonctionnel.ods)) \| et Excel ([xlsx](/ressources/Doc4.0.0/autres/fonctionnel/VITAM_cahier_de_recette_fonctionnel.xlsx)) avec les fichiers de tests associés ([zip](https://download.programmevitam.fr/jeux_de_tests/r16/Jeux_de_tests_fonctionnels_R16.zip))

## Documentation technique
* **Dossier d'architecture technique** (DAT) ([pdf](/ressources/Doc4.0.0/pdf/vitam-architecture.4.0.3.pdf) \| [html](/ressources/Doc4.0.0/html/archi))
* **Dossier d'exploitation** (DEX) ([pdf](/ressources/Doc4.0.0/pdf/vitam-documentation-exploitation.4.0.3.pdf) \| [html](/ressources/Doc4.0.0/html/exploitation))
* **Dossier d'installation** (DIN) ([pdf](/ressources/Doc4.0.0/pdf/vitam-documentation-installation.4.0.3.pdf) \| [html](/ressources/Doc4.0.0/html/installation))
* **Documentation de montées de version** (DMV) ([pdf](/ressources/Doc4.0.0/pdf/vitam-documentation-migration.4.0.3.pdf) \| [html](/ressources/Doc4.0.0/html/migration))

## Documentation développeur
* **Javadoc** ([html](/ressources/Doc4.0.0/javadoc))
* **Manuel d'intégration applicative** - présentation des principes de d'usage des interfaces ([pdf](/ressources/Doc4.0.0//pdf/vitam-manuel-integration.4.0.3.pdf) \| [html](/ressources/Doc4.0.0//html/manuel-integration))
* **Modèle de données** - description des collections et des champs standards  
([pdf](/ressources/Doc4.0.0//autres/fonctionnel/VITAM_Modele_de_donnees.pdf))
* **Documentation d'API externes** - description des API REST externes en Html ([html](/ressources/Doc4.0.0//raml/externe))
* **Manuel de développement** - éléments d'architecture interne et de méthode utiles aux développements de la solution logicielle VITAM ([pdf](/ressources/Doc4.0.0//pdf/vitam-manuel-developpement.4.0.3.pdf)
\| [html](/ressources/Doc4.0.0//html/manuel-dev))
* **Documentation d'API internes** - description des API REST internes en Html et Raml ([html&raml](/ressources/Doc4.0.0//raml/interne))
...
* **Vitam UI : documentation produit** ([pdf](/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_Doc_produit.pdf))
...
<caption><b>Domaine : organisation et droits utilisateurs<a name="orga"></a></b></caption>
	...
	<tr>
		...
		<td>... créer une nouvelle organisation utilisatrice de Vitam UI et lui associer 1 ou plusieurs coffre(s)</td>
		<td>... administrateur d'instance (si vous exposez Vitam UI en tant que service), administrateur technique VitamUI (si vous utilisez Vitam UI hébergé en propre)</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_organisation.pdf">Organisation</a></td>
	</tr>
	<tr>
		<td>1.2 (obligatoire)</td>
		<td>... créer le compte nominatif de l'administrateur fonctionnel d'une organisation à des fins d'activation et prendre la main sur la session d'un utilisateur à des fins de support</td>
		<td>... administrateur d'instance (si vous exposez Vitam UI en tant que service), administrateur technique VitamUI (si vous utilisez Vitam UI hébergé en propre)</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_subrogation.pdf">Subrogation</a></td>
	</tr>
	<tr>
		<td>1.2 (facultatif)</td>
		<td>... définir des droits fins sur les utilisateurs de mon organisation en créant un nouveau profil de droits</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_profil_app_utilisateur.pdf">Profil APP Utilisateur</a></td>
	</tr>
	<tr>
		<td>1.3 (obligatoire sauf si le groupe existe déjà)</td>
		<td>... définir des regroupements de droits sur les APPs Vitam UI pour mes utilisateurs en créant un nouveau groupe de profils</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_groupe_profil.pdf">Groupes de profils</a></td>
	</tr>
	<tr>
		<td>1.4 (obligatoire sauf si le groupe existe déjà)</td>
		<td>... créer mes utilisateurs et leur attribuer des droits</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_utilisateur.pdf">Utilisateur</a></td>
	</tr>
</table>
<table>
<caption><b>Domaine : référentiels<a name="referentiels"></a></b></caption>
	...
	<tr>
		...
		<td>... déclarer un nouveau service producteur ou un nouveau service versant dans Vitam UI</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_services_agents.pdf">Services agents</a></td>
	</tr>
	<tr>
		<td>2.2 (Règles de gestion)</td>
		<td>... déclarer des nouvelles règles de gestion</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Regles_gestion.pdf">Règles de gestion</a></td>
	</tr>
	<tr>
		<td>2.2 (facultatif)</td>
		<td>... déclarer un nouveau format non présent dans le référentiel PRONOM</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_formats_fichiers.pdf">Formats de fichier</a></td>
	</tr>
	<tr>
		<td>2.3 (facultatif)</td>
		<td>... déclarer un nouveau vocabulaire non présent dans l'ontologie SEDA</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_ontologie.pdf">Ontologie</a></td>
	<tr>
		<td>2.4 (facultatif)</td>
		<td>... importer un arbre de positionnement ou un plan de classement</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Arbres_plans.pdf">Arbres et plans</a></td>
	</tr>
	</tr>
</table>
<table>
<caption><b>Domaine : sécurité et droits applicatifs<a name="secu"></a></b></caption>
	...
	<tr>
		...
		<td>... paramétrer des droits pour le versement d'archives dans un coffre par une nouvelle application</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_contrat_entree.pdf">Contrat d'entrée</a></td>
	</tr>
	<tr>
		<td>3.2 (obligatoire sauf si le contrat existe déjà)</td>
		<td>... paramétrer des droits pour la consultation ou mise à jour d'archives dans un coffre par une nouvelle application</td>
		<td>... administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_contrat_acces.pdf">Contrat d'accès</a></td>
	</tr>
	<tr>
		<td>3.3 (obligatoire sauf si le contrat existe déjà)</td>
		<td>... définir les droits d'une nouvelle application sur les services exposés par Vitam</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Profil_securite.pdf">Profil de sécurité</a></td>
	</tr>
	<tr>
		<td>3.4 (obligatoire sauf si le contrat existe déjà)</td>
		<td>... authentifier une nouvelle application interconnectée avec Vitam et lui attribuer des droits</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_contexte_applicatif.pdf">Contexte applicatif</a></td>
	</tr>
...
<caption><b>Domaine : supervision et audit<a name="supervision"></a></b></caption>
	...
	<tr>
		...
		<td>... consulter le journal des opérations VITAM (entrées, éliminations et données de base)</td>
		<td>... administrateur technique Vitam UI ou administrateur fonctionnel Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Journal_operations.pdf">Journal des opérations</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... visualiser les opérations de sécurisation et accéder aux journaux du cycle de vie des objets</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_operations_securisation.pdf">Opérations de sécurisation</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... effectuer des requêtes complexes sur les bases de données documentaires en vue de retrouver des objets</td>
		<td>... administrateur technique Vitam UI</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_RequetesDSL.pdf">Requêtes DSL</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... vérifier la conformité de la conservation de mes archives</td>
		<td>... administrateur fonctionnel Vitam UI, super-archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Audit.pdf">Audit</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... produire un relevé de valeur probante sur une ou plusieurs de mes archives électroniques</td>
		<td>... administrateur fonctionnel Vitam UI, super-archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_releve_valeur_probante.pdf">Relevé de valeur probante</a></td>
	</tr>
</table>
<table>
<caption><b>Domaine : versement et consultation<a name="versement"></a></b></caption>
	...
	<tr>
		...
		<td>... déposer un lot d'archives dans le SAE et en visualiser l'entrée</td>
		<td>... archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Depot_suivi_versements.pdf">Dépôt et suivi des versements</a></td>
	</tr>
	<tr>
		<td>NA</td>
		<td>... rechercher et télécharger des unités archivistiques contenues dans le SAE</td>
		<td>... archiviste</td>
		<td><a href="https://www.programmevitam.fr/ressources/Doc4.0.0/autres/fonctionnel/VitamUI_DocAPP_Recherche_consultation.pdf">Recherche et consultation des archives</a></td>
	</tr>
</table>
...
* **Présentation de la solution logicielle** - mode de développement, vision générale fonctionnelle et technique de la solution
([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Presentation_solution_logicielle.pdf))
...
* **Spécification des SIP** - recommandations sur la construction des paquets
à archiver ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Structuration_des_SIP.pdf))
* **Structuration des DIP** - éléments sur la construction paquets d'archives transmis par le système d’archivage pour consultation
([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Structuration_des_DIP.pdf))
* **Arbre de positionement et plan de classement** - description des principes d'organisation et de classement des unités archivistiques
([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_ArbresEtPlans.pdf))
* **Règles de gestion** - présentation du principe des règles de gestion et de leur héritage
([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Regles_de_gestion.pdf))
* **Services producteurs** - présentation des fonctionnalités associées à la
notion de service producteur ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Services_producteurs.pdf))
* **Eliminations** - présentation des fonctionnalités de mise en oeuvre des éliminations d'archives avec la solution logicielle Vitam ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Eliminations.pdf))
* **Préservation** - présentation des fonctionnalités de mise en oeuvre de la préservation à long-terme des archives avec la solution logicielle Vitam ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Preservation.pdf))
* **Profils d’archivage** - éléments sur la notion de profil d’archivage (SEDA) ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Profils_d_archivage.pdf))
* **Profils d’unité archivistique** - éléments sur la notion de profil d’unité archivistique ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_ProfilsDuniteArchivistique.pdf))
* **Ontologie** - éléments sur la notion d'ontologie ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Ontologie.pdf))
* **Conservation de la valeur probante** - présentation de la sécurisation des journaux ([pdf](//ressources/Doc3.6.0autres/fonctionnel/VITAM_Conservation_valeur_probante.pdf))
* **Gestion des habilitations** - présentation des fonctionnalités associées à la gestion et à
l’utilisation des habilitations (gestion des utilisateurs applicatifs et de leurs droits) ([pdf](/ressources/Doc3.6.0autres/fonctionnel/VITAM_Gestion_habilitations.pdf))
* **Modèle de workflow**  - description de la décompositon et du séquencement des
 opérations ([pdf - partie 1](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Modele_de_workflow_part1.pdf)) ([pdf - partie 2](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Modele_de_workflow_part2.pdf))
* **Gestion de multiples stratégies de stockage** - présentation des fonctionnalités associées à la gestion et à la réalisation d'opérations de préservation numérique ([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Multi_strategies.pdf))
...
* **Modèle de données** - description des collections et des champs standards  
([pdf](/ressources/Doc3.6.0/autres/fonctionnel/VITAM_Modele_de_donnees.pdf))
* **Documentation d'API externes** - description des API REST externes en Html ([html](/ressources/Doc3.6.0/raml/externe))
* **Manuel de développement** - éléments d'architecture interne et de méthode utiles aux développements de la solution logicielle VITAM ([pdf](/ressources/Doc3.6.0/pdf/vitam-manuel-developpement.3.6.0.pdf)
\| [html](/ressources/Doc3.6.0/html/manuel-dev))
* **Documentation d'API internes** - description des API REST internes en Html et Raml ([html&raml](/ressources/Doc3.6.0/raml/interne))
* **Sedalib** [html](http://download.programmevitam.fr/resip/1.1/javadoc-sedalib1.1/)
...
* **Manuel utilisateur** ([pdf](/ressources/Doc1.10.0/pdf/vitam-manuel-utilisateur.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0/html/manuel-utilisateur))
...
([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Organisation_de_l_information.pdf))
* **Spécification des SIP** - recommandations sur la construction des paquets 
à archiver ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Structuration_des_SIP.pdf))
* **Structuration des DIP** - éléments sur la construction paquets d'archives transmis par le système d’archivage pour consultation
([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Structuration_des_DIP.pdf))
* **Profils d’archivage** - éléments sur la notion de profil d’archivage (SEDA) ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Profils_d_archivage.pdf))
* **Profils d’unité archivistique** - éléments sur la notion de profil d’unité archivistique ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Profils_unite_archivistique.pdf))
* **Gestion des habilitations** - présentation des fonctionnalités associées à la gestion et à
l’utilisation des habilitations (gestion des utilisateurs applicatifs et de leurs droits) ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Gestion_des_habilitations.pdf))
* **Services producteurs** - présentation des fonctionnalités associées à la
notion de service producteur ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Services_producteurs.pdf))
* **Arbre de positionement et plan de classement** - description des principes d'organisation et de classement des unités archivistiques 
([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Arbre_de_positionnement_et_plan_de_classement.pdf))
* **Règles de gestion** - présentation du principe des règles de gestion et de leur héritage 
([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Regles_de_gestion.pdf))
* **Modèle de workflow**  - description de la décompositon et du séquencement des
 opérations ([pdf](/ressources/Doc1.10.0/pdf/vitam-modele-workflow.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/workflow-model))
* **Conservation de la valeur probante** - présentation de la sécurisation des journaux ([pdf](/ressources/Doc1.10.0/autres/fonctionnel/VITAM_Valeur_probante.pdf))


## Documentation des tests

* **Manuel IHM recette** ([pdf](/ressources/Doc1.10.0/pdf/vitam-ihm-recette.1.10.0-1.pdf) 
...
* **Dossier d'architecture technique** (DAT) ([pdf](/ressources/Doc1.10.0/pdf/vitam-architecture.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/archi))
* **Dossier d'exploitation** (DEX) ([pdf](/ressources/Doc1.10.0/pdf/vitam-documentation-exploitation.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/exploitation))
* **Dossier d'installation** (DIN) ([pdf](/ressources/Doc1.10.0/pdf/vitam-documentation-installation.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/installation))
* **Documentation de montées de version (DMV) ([pdf](/ressources/Doc1.10.0/pdf/vitam-documentation-migration.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/migration))

## Documentation développeur

* **Javadoc** ([html](/ressources/Doc1.10.0/javadoc))
* **Manuel d'intégration applicative** - présentation des principes de d'usage des interfaces ([pdf](/ressources/Doc1.10.0/pdf/vitam-manuel-developpement.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/manuel-integration))
* **Modèle de données** - description des collections et des champs standards  
([pdf](/ressources/Doc1.10.0/pdf/vitam-datamodel.1.10.0-1.pdf) \| [html](/ressources/Doc1.10.0/html/data-model))
* **Documentation d'API externes** - description des API REST externes en Html ([html](/ressources/Doc1.10.0/raml/externe/index.htm))
* **Manuel de développement** - éléments d'architecture interne et de méthode utiles aux développements de la solution logicielle VITAM ([pdf](/ressources/Doc1.10.0/pdf/vitam-manuel-developpement.1.10.0-1.pdf) 
\| [html](/ressources/Doc1.10.0/html/manuel-dev))
* **Documentation d'API internes** - description des API REST internes en Html et Raml ([html&raml](/ressources/Doc1.10.0/raml/interne/index.htm))
